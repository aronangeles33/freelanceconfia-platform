        ...
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              Inicia Sesión en FreelanceConfía
            </h1>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Accede a tu cuenta y conecta con oportunidades de trabajo increíbles
            </p>
          </div>
            ...
            <div>
              <div className="mb-8">
                ...
                <p className="text-gray-600 text-lg text-center lg:text-left">
                  Únete a miles de freelancers y empresas que confían en nuestra plataforma 
                  para colaborar de forma segura y eficiente.
                </p>
              </div>
              ...
              <div className="mt-8 text-center lg:text-left">
                <p className="text-gray-600 mb-4">¿Nuevo en FreelanceConfía?</p>
